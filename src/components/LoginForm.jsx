...
import {
  ...
  findUser,
  setCurrentUser,
} from "../utils/db"; // наш localStorage "db"
    ...
    >
      ...
      >
        ...
        <button type="submit" style={buttonStyle}>
          {mode === "register" ? "Registration" : "Log in"} ▶️
        </button>
        ...
        <p style={{color:"rgb(255, 255, 255, 0.08)",marginBottom:"10px"}}>Pay attention if you clean browser data you will lose your account and all songs!</p>
      </form>
    </div>
  );
};
